...
<div class="bloc">
    ...
    <div class="content">
        <form action="../proccess_main/product_option2" method="post" id="frm_computer" name="frm_computer" enctype="multipart/form-data" >
            ...
            <tbody>
                 ...
                 <tr>
                   ...
                   <tr>
                      ...
                      <tr>
                        <td><span class="sp_title">Chuẩn kết nối :</span></td>
                        <td>
