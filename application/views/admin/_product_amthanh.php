...
<div class="bloc">
    <div class="title">
        THÊM SẢN PHẨM LOA - ÂM THANH MỚI
    </div>
    <div class="content">
        <form action="../proccess_main/product_amthanh" method="post" id="frm_computer" name="frm_amthanh" enctype="multipart/form-data" >
            ...
            <tbody>
                <?php 
                   ...
                   <tr>
                      ...
                      <tr>
                        <td><span class="sp_title">Kênh ra :</span></td>
                        <td>
                      ...
                      <tr>
                        <td><span class="sp_title">Điều khiển :</span></td>
                        <td>
                            <?php 
                            if ($spd03 == "Hiển thị") {
                                $hient = "Selected";
                            ...
                            <select name="spd03" id="sl_vat">
                                <option value="Hiển thị" <?php echo $hient; ?> >Hiển thị</option>
                                <option value="Không" <?php echo $khient; ?> >Không</option>
                            </select>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                            <input type="text" name="spkm" id="spkm" class="td_long" <?php echo $spkm; ?> />
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <select name="spd01" id="sl_vat">
                                <option value="Dây" <?php echo $day; ?> >Dây</option>
                                <option value="Không dây" <?php echo $kday; ?> >Không dây</option>
                            </select>
                        </td>
