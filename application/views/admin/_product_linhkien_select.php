...
<div class="bloc">
    <div class="title">
        THÊM SẢN PHẨM LINH KIỆN MỚI
    </div>
    <div class="content">
        <form action="../proccess_main/product_option3" method="post" id="frm_computer" name="frm_computer" enctype="multipart/form-data" >
                ...
                <?php 
                 ...
                 <tr>
                   ...
                   <tr>
                        ...
                        <td><input type="hidden" value="<?php echo $select_option ?>" name="sploai" />
                      ...
                      <tr>
                        ...
                        <td>
                            <input type="text" name="spbh" id="spbh" value="<?php if ($spbh != "") {
                                echo $spbh;
                            }else echo "12"; ?> "/> &nbsp;Tháng
                        </td>
                    </tr>
                      <tr>
                       <?php if ($select_option == "11"):?>
                        <td><span class="sp_title">Tốc độ :</span></td>
                        <td>
                            <input type="text" name="spd02" id="spd02" class="td_long" value="<?php echo $spd01; ?>" />
                        </td>
                        
                        <?php elseif ($select_option == "12"):?>
                         <td><span class="sp_title">Hỗ trợ CPU :</span></td>
                        <td>
                            <input type="text" name="spd01" id="spd01" class="td_long" value="<?php echo $spd01; ?>" />
                        </td>
                         
                        <?php elseif ($select_option == "13"):?>
                         <td><span class="sp_title">Loại RAM :</span></td>
                        <td>
                            <input type="text" name="spd01" id="spd01" class="td_long" value="<?php echo $spd01; ?>" />
                        </td> 
                        
                        <?php elseif ($select_option == "14"):?>
                         <td><span class="sp_title">Chuẩn :</span></td>
                        <td>
                            <input type="text" name="spd01" id="spd01" class="td_long" value="<?php echo $spd01; ?>" />
                        </td> 
                        
                        <?php elseif ($select_option == "15"):?>
                         <td><span class="sp_title">Loại RAM :</span></td>
                        <td>
                            <input type="text" name="spd01" id="spd01" class="td_long"  value="<?php echo $spd01; ?>"/>
                        </td> 
                        
                        <?php elseif ($select_option == "16"):?>
                         <td><span class="sp_title">Kiểu :</span></td>
                        <td>
                            <input type="text" name="spd01" id="spd01" class="td_long" value="<?php echo $spd01; ?>" />
                        </td> 
                        <?php elseif ($select_option == "17"):?>
                        ...
                        <?php elseif ($select_option == "19"):?>
                         <td><span class="sp_title">Kết nôi :</span></td>
                        <td>
                            <input type="text" name="spd01" id="spd01" class="td_long" value="<?php echo $spd01; ?>" />
                        </td> 
                        
                        <?php elseif ($select_option == "22"):?>
                         <td><span class="sp_title">Kết nối :</span></td>
                        <td>
                        ...
                        <?php elseif ($select_option == "25"):?>
                         <td><span class="sp_title">Dung lượng :</span></td>
                        <td>
                            <input type="text" name="spd01" id="spd01" class="td_long" value="<?php echo $spd01; ?>" />
                        </td> 
                      ...
                      <tr>
                       <?php if ($select_option == "11"):?>
                        <td><span class="sp_title">Dòng CPU :</span></td>
                        <td>
                            <input type="text" name="spd01" id="spd01" class="td_long"  value="<?php echo $spd01; ?>"/>
                        </td>
                       <?php elseif ($select_option == "12"):?>
                         <td><span class="sp_title">Hỗ trợ RAM :</span></td>
                        <td>
                            <input type="text" name="spd04" id="spd04" class="td_long" value="<?php echo $spd04; ?>" />
                        </td>
                        ...
                        <td>
                         ...
                         <?php elseif ($select_option == "16"):?>
                         <td><span class="sp_title">Kích thước :</span></td>
                        <td>
                            <input type="text" name="spd02" id="spd02" class="td_long" value="<?php echo $spd02; ?>" />
                        </td> 
                        <?php elseif ($select_option == "17"):?>
                        ...
                        <td></td>
                         ...
                         <?php elseif ($select_option == "19"):?>
                         <td><span class="sp_title">Loại :</span></td>
                        <td>
                            <input type="text" name="spd02" id="spd02" class="td_long" value="<?php echo $spd02; ?>" />
                        </td> 
                        
                        <?php elseif ($select_option == "22"):?>
                         <td><span class="sp_title">Kiểu chuột :</span></td>
                        <td>
                           
                            <select name="spd03" id="sl_vat">
                                <option value="Bi lăn" <?php echo $bl; ?> >Bi lăn</option>
                                <option value="Quang học" <?php echo $qh; ?>>Quang học</option>
                                <option value="Laser" <?php echo $ls; ?>>Laser</option>
                            </select>
                        </td> 
                    ...
                    <tr>
                        <?php if ($select_option == "11"):?>
                        <td><span class="sp_title">Cache :</span></td>
                        <td>
                            <input type="text" name="spd04" id="spd04" class="td_long" value="<?php echo $spd04; ?>" />
                        </td>
                         <?php elseif ($select_option == "12"):?>
                             
                         <td><span class="sp_title">Chipset :</span></td>
                        <td>
                            <input type="text" name="spd03" id="spd03" class="td_long" value="<?php echo $spd03; ?>" />
                        </td>
                         
                         <?php elseif ($select_option == "13"):?>
                         <td><span class="sp_title">Tốc độ BUS :</span></td>
                        <td>
                            <input type="text" name="spd03" id="spd03" class="td_long"  value="<?php echo $spd03; ?>"/>
                        </td>
                        ...
                        <?php elseif ($select_option == "16"):?>
                         <td><span class="sp_title">Độ phân giải :</span></td>
                        <td>
                            <input type="text" name="spd03" id="spd03" class="td_long" value="<?php echo $spd03; ?>" />
                        </td> 
                        <?php elseif ($select_option == "17"):?>
                    ...
                    <tr>
                        ...
                        <td><span class="sp_title">Tốc độ Bus :</span></td>
                        <td>
                            <input type="text" name="spd05" id="spd05" class="td_long" value="<?php echo $spd05; ?>" />
                        </td>
                        <?php elseif ($select_option == "12"):?>
                             
                         <td><span class="sp_title">VAG OnBoard :</span></td>
                        <td>
                            <input type="text" name="spd05" id="spd05" class="td_long" value="<?php echo $spd05; ?>" />
                        </td>
                    ...
                    <tr>
                        <?php if ($select_option == "11"):?>
                        <td><span class="sp_title">Socket :</span></td>
                        <td>
                            <input type="text" name="spd03" id="spd03" class="td_long" value="<?php echo $spd03; ?>" />
                        </td>
                        <?php elseif ($select_option == "12"):?>
